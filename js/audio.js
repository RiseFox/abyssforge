...
(() => {
  ...
  const sounds = {
    ...
    event() { tone({ freq: 220, type: "triangle", dur: 0.12, vol: 0.032 }); tone({ freq: 330, type: "sine", dur: 0.16, vol: 0.026, delay: 0.1 }); },
    rumble() { noise({ dur: 0.28, vol: 0.07, freq: 260 }); tone({ freq: 72, end: 45, type: "sine", dur: 0.34, vol: 0.055 }); },
  ...
  const music = {
    ...
    camp: {
      tempo: 560,
      bass: [130, 0, 164, 0, 196, 0, 164, 0],
      lead: [262, 0, 330, 392, 0, 330, 294, 0, 262, 0, 220, 247, 0, 294, 330, 0],
      type: "triangle",
      leadVol: 0.019,
      bassVol: 0.013
    },
