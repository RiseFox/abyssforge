(() => {
  ...
  const RECIPE_GATES = {
    ...
    clockworkRegulator: { item: "clockwork" },
    ...
    mirrorCache: { item: "mirrorShard" },
    keyedRelic: { item: "strangeKey" },
    voidglassEdge: { item: "voidglass" },
    fieldKit: { item: "mushroom" },
    merchantKit: { item: "coin" },
    merchantTorchCrate: { item: "coin" },
    lampCells: { item: "copper" },
    quartzCells: { item: "quartz" },
    ...
    vaultKit: { item: "silk" },
    bossTonic: { item: "core" },
    surveyCache: { item: "mapScrap" },
    emberRation: { item: "ember" },
    coinPress: { item: "gold" },
