...
- `test:assets` checks that normalized cache sprites, cache-opening frames, mob-wake frames, sliced sheet icons, derived CSS icons, and recover-heart FX are actually instantiated, not only present in the packed asset bundle.
